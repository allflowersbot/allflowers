...
1.1.1. Публичная оферта / Оферта – текст настоящего документа со всеми приложениями, изменениями и дополнениями к нему, размещенный на Сайте и доступный в сети Интернет по адресу:
...
1.1.11. Сайт – автоматизированная информационная система, доступная в сети Интернет по сетевому адресу: https:.
...
3.1.1. Пользовательское соглашение, размещенное и/или доступное в сети Интернет по адресу https:и включающее общие условия регистрации на Сайте и использования Сервиса;

3.1.2. Политика конфиденциальности, размещенная и/или доступная в сети Интернет по адресу https:, и содержащая правила предоставления и использования персональной информации Продавца и Покупателя.

3.1.3. Публичная оферта о заключении договора купли-продажи – размещенное и/или доступное в сети Интернет по адресу https:предложение Агента о заключении Сделки, содержащее обязательные условия, на которых осуществляется заключение и исполнение Сделок с использованием Сервиса.
